...
import TaskListModular from './task-list-modular'
...
function TodoModular() {
    ...
    const handleSubmit = (e) => {
        ...
        if (isEdit) {
            ...
            setIsEdit(false)
            setCurrentUserTask({})
            history.push('/ContactListUSeHistory/AddUserTask')
        } else {
    ...
    return (
        <>
            ...
            <div className='div-list mx-auto mt-5 todolist-bg'>
                ...
                <Switch>
                    < Route path='/TodoModular/AddUserTask'>
                        <AddUserTask
                    ...
                    < Route path='/TodoModular/TaskListModular'>
                        <TaskListModular
                            editTask={editTask}
